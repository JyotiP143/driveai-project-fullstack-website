...
export default function AiAssistant() {
  ...
  const [messages, setMessages] = useState([{ role: 'assistant', text: "Hello! I'm your Aetheria AI Assistant. How can I help you navigate our lineup today?" }]);
  ...
  const parseAndApplyResponse = (text) => {
    try {
      ...
      return parsed.reply || "I've updated the site for you.";
    } catch (e) {
  ...
  const handleSend = async (e) => {
    ...
    if (!API_KEY) {
      ...
      { role: 'system', text: "Please add VITE_GEMINI_API_KEY to your .env file to enable AI functionality." }
      ]);
      setInput('');
      return;
    }
    ...
    try {
      ...
      const contextualPrompt = `[Current UI State: Currency=${state.currency}, Filter=${state.modelFilter.type}] User Request: ${userMessage}`;
